...
import { createCloudflarePacketRenderer, createCloudflareStageRunner } from "./source-runner.js";
...
const stageRunner = createCloudflareStageRunner({ workerUrl, apiToken: sourceToken });
const packetRenderer = createCloudflarePacketRenderer({ workerUrl, apiToken: sourceToken });
...
const processWorker = new DocumentPrepWorker({ repository: new PostgresProcessRepository(pool), stageRunner, packetRenderer, objectStore: storage });
