...
function assertStaticContracts() {
  ...
  assert.match(shellCss, /\.nav-item:not\(\.is-active\):not\(:disabled\):is\(:hover, :focus-visible, :active\) \.nav-icon \{[\s\S]*drop-shadow\(0 0\.0625rem 0\.125rem rgb\(10 132 255 \/ 24%\)\)/, "navigation feedback must use the restrained directional glyph shadow");
