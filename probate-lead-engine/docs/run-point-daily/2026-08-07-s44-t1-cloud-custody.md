...
- Controlling Cloud environment ID, canonical 32-character form: `3ebe7ef6abe2418495f55828aa343217`
- Platform environment value: UUID form of the same identifier, separators retained by the host
...
- Managed workspace: `/workspaces/heir-right`
- Repository attachment proof: the Codespaces control plane reports `repository: nicharacci/heir-right` and `owner: nicharacci`
- Exact base: `809c28404a7645d85ff2683c252f04cf30a34e3b`
- Checkout mode: clean detached checkout
- Publication route: authenticated HTTPS `origin` at `https://github.com/nicharacci/heir-right.git`; the successful route uses the GitHub CLI host credential for the verified actor
- Authenticated GitHub actor: `nicharacci`
- Permission profile: Full Access; writable filesystem, outbound Git, authenticated GitHub API, and HTTPS push dry-run verified
- Codespace machine: `basicLinux32gb`
- Codespace idle timeout: `30` minutes
- Codespace retention: `10080` minutes, exactly seven days after shutdown
- Date integration branch: `2026-08-06`
- Owner: Cloud environment and custody setup
